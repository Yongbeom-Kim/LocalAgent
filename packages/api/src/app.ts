...
import { MAX_API_JSON_BODY_BYTES, type ApiAuthConfig } from '@local-agent/shared';
...
export function createApp(rabbitmq: RabbitMQService, auth: ApiAuthConfig): express.Application {
  const app = express();
